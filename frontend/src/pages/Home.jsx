...
import aboutImage from "../assets/media/about-home.JPG";
...
const Home = () => {
  ...
  const allImages = selectedEvent
    ? [
        selectedEvent.mainImage || selectedEvent.image,
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-10 md:py-24 bg-white">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="w-full h-full rounded-xl overflow-hidden relative shadow-2xl flex items-center justify-center bg-[#fdf9ee] group">
              <img src={aboutImage} alt="about-home" />
            </div>
          </div>
          <div>
            <h2 className="text-2xl font-bold tracking-wide text-secondary uppercase mb-2">
              About Us
            </h2>
            ...
            <Link
              to="/about"
              className="text-primary font-bold hover:brightness-90 inline-flex items-center gap-2 text-lg group"
            >
              Read Our Full Story{" "}
              <ArrowRight
                size={20}
      ...
      <Snap3DCarousel
        ...
        onImageClick={(item, idx) => openModal(galleryItems[idx])}
      />
        ...
        {selectedEvent && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-10 pointer-events-none">
            ...
            <div className="container mx-auto h-full flex flex-col items-center justify-center p-4 z-10 pointer-events-auto">
              ...
              <motion.div className="w-full max-w-5xl relative group flex flex-col items-center">
                {/* Image Section */}
                <div className="w-full relative flex items-center justify-center">
                  <AnimatePresence mode="wait">
                    <motion.img
                      ...
                      layoutId={
                        currentImgIdx === 0
                          ? `carousel-img-${selectedEvent._id || galleryItems.indexOf(selectedEvent)}`
                          : undefined
                      }
                  ...
                  {allImages.length > 1 && (
                    <div className="absolute inset-0 flex items-center justify-between px-4 md:px-6 opacity-0 group-hover:opacity-100 transition-opacity z-[100] pointer-events-none">
                      <button
                        ...
                        onClick={prevImg}
                        className="pointer-events-auto w-12 h-12 md:w-16 md:h-16 rounded-full bg-black/50 backdrop-blur-md border border-white/20 text-white flex items-center justify-center hover:bg-primary transition-colors"
                      >
                        <ChevronLeft size={32} />
                      </button>
                      <button
      ...
      <section className="py-10 md:py-24 bg-secondary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-gray-800 mb-10 max-w-2xl mx-auto">
            Your support can bring new hope, new opportunities, and a brighter
            tomorrow.
          </p>
          <div className="flex gap-4 justify-center">
            <Link
              to="/contact"
              className="bg-gray-900 text-white px-8 py-4 rounded-full font-bold shadow-lg hover:bg-gray-800 transition-colors"
            >
              Become a Volunteer
            </Link>
            <Link
              to="/donate"
              className="bg-white text-gray-900 px-8 py-4 rounded-full font-bold shadow-lg hover:bg-gray-100 transition-colors"
            >
              Make a Donation
            </Link>
          </div>
